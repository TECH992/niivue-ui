...
export default function NiiVue(props) {
  ...
  const [crosshairColor, setCrosshairColor] = React.useState(
    nv.opts.crosshairColor,
  );
  const [selectionBoxColor, setSelectionBoxColor] = React.useState(
    nv.opts.selectionBoxColor,
  );
  const [backColor, setBackColor] = React.useState(nv.opts.backColor);
  const [clipPlaneColor, setClipPlaneColor] = React.useState(
  ...
  const [crosshairOpacity, setCrosshairOpacity] = React.useState(
    nv.opts.crosshairColor[3],
  );
  const [clipPlaneOpacity, setClipPlaneOpacity] = React.useState(
    nv.opts.clipPlaneColor[3],
  );
  ...
  const [maxDrawUndoBitmaps, setMaxDrawUndoBitmaps] = React.useState(
    nv.opts.maxDrawUndoBitmaps,
  );
  const [sagittalNoseLeft, setSagittalNoseLeft] = React.useState(
    nv.opts.sagittalNoseLeft,
  );
  const [rulerWidth, setRulerWidth] = React.useState(nv.opts.rulerWidth);
  const [longTouchTimeout, setLongTouchTimeout] = React.useState(
    nv.opts.longTouchTimeout,
  );
  const [doubleTouchTimeout, setDoubleTouchTimeout] = React.useState(
    nv.opts.doubleTouchTimeout,
  );
  const [dragToMeasure, setDragToMeasure] = React.useState(
    nv.opts.isDragShowsMeasurementTool,
  );
